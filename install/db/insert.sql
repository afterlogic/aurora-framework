...
/*!40000 ALTER TABLE `eav_attributes_bool` DISABLE KEYS */;
INSERT INTO `eav_attributes_bool` (`id`, `id_entity`, `name`, `value`) VALUES
	...
	(29, 7, 'FilesEnable', 1),
	(37, 8, 'IsDisabled', 0);
/*!40000 ALTER TABLE `eav_attributes_bool` ENABLE KEYS */;

/*!40000 ALTER TABLE `eav_attributes_datetime` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `eav_attributes_datetime` ENABLE KEYS */;

/*!40000 ALTER TABLE `eav_attributes_int` DISABLE KEYS */;
INSERT INTO `eav_attributes_int` (`id`, `id_entity`, `name`, `value`) VALUES
	...
	(33, 8, 'IdUser', 7);
/*!40000 ALTER TABLE `eav_attributes_int` ENABLE KEYS */;

/*!40000 ALTER TABLE `eav_attributes_string` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `eav_attributes_string` ENABLE KEYS */;

/*!40000 ALTER TABLE `eav_attributes_text` DISABLE KEYS */;
INSERT INTO `eav_attributes_text` (`id`, `id_entity`, `name`, `value`) VALUES
	(1, 5, 'Text', 'test');
/*!40000 ALTER TABLE `eav_attributes_text` ENABLE KEYS */;
