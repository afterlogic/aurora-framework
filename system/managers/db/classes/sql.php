...
class CDbSchema
{
	...
	public static function AwmAccounts()
	{
		return new CDbTable('awm_accounts', CDbSchemaHelper::prefix(), array(
			...
			new CDbField('is_password_specified', CDbField::BIT, 1),
			new CDbField('allow_mail', CDbField::BIT, 1),
		), array(
	...
	public static function AwmSettings()
	{
		return new CDbTable('awm_settings', CDbSchemaHelper::prefix(), array(
			...
			new CDbField('helpdesk_signature', CDbField::VAR_CHAR, ''),
			new CDbField('helpdesk_signature_enable', CDbField::BIT, 0),
			...
			new CDbField('email_notification', CDbField::VAR_CHAR, ''),
			new CDbField('password_reset_hash', CDbField::VAR_CHAR, ''),
		), array(
	...
	public static function AwmTenants()
	{
		return new CDbTable('awm_tenants', CDbSchemaHelper::prefix(), array(
			...
			new CDbField('calendar_notification_email_account', CDbField::VAR_CHAR, ''),
			new CDbField('invite_notification_email_account', CDbField::VAR_CHAR, '')
		), array(
...
//			new CDbField('password_must_be_complex', CDbField::BIT, 0)
	...
	public static function AwmAddrBook()
	{
		return new CDbTable('awm_addr_book', CDbSchemaHelper::prefix(), array(
			...
			new CDbField('use_frequency', CDbField::INT, 1),
...
//			new CDbField('autoaddinvitation', CDbField::BIT, 0),
	...
	public static function AhdUsers()
	{
		return new CDbTable('ahd_users', CDbSchemaHelper::prefix(), array(
			...
			new CDbField('signature', CDbField::VAR_CHAR, ''),
			new CDbField('signature_enable', CDbField::BIT, 0),
		), array(
