...
(function ($, window) {
	 ...
	 * @param {Object} oEvent
	 */
	Crea.prototype.onClickWith = function (oEvent)
	{
		if(oEvent.ctrlKey) {
	 ...
	 * @param {Object} oEvent
	 */
	Crea.prototype.onButtonPressed = function (oEvent)
	{
		var iKey = -1;
		if (window.event)
		{
	 ...
	 * @returns {Boolean}
	 */
	Crea.prototype.pasteImage = function (oEvent)
	{
		var
	 ...
	 * @param {string} sFontName
	 */
	Crea.prototype.getFontNameWithFamily = function (sFontName)
	{
		var sFamily = '';
...
(function($) {
	...
	var inputosaurustext = {
		...
		_createTag: function (key, fullValue) {
			var
				oEmail = AfterLogicApi.getEmailParts(fullValue, true),
