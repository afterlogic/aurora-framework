 ...
 */
Utils.Message.showInlinePictures = function ($html, aAttachments, aFoundCids, sAppPath)
{
	var
 ...
 * @param {object} $html JQuery element containing message body html
 */
Utils.Message.showExternalPictures = function ($html)
{
...
{
	if (AppData.AllowIdentities && (this.isCurrentAllowsMail() || this.collection().length > 1))
	{
...
{
	return _.uniq(_.map(AppData.Accounts.collection(), function (oAccount) {
...
CFolderModel.prototype.initStarredFolder = function (iLevel, sFullName)
{
	...
	this.name(Utils.i18n('MAIN/FOLDER_STARRED'));
...
CFolderModel.prototype.initSubscriptions = function (sParentFullName)
{
	...
	this.subscribed.subscribe(function () {
		if (sParentFullName)
		{
			var oParentFolder = App.MailCache.folderList().getFolderByFullName(sParentFullName);
			if(oParentFolder)
			{
...
CFolderModel.prototype.initComputedFields = function (bDisableManageSubscribe)
{
	this.routingHash = ko.computed(function () {
		...
		if (this.bVirtual)
		{
			return App.Routing.buildHashFromArray(App.Links.mailbox(this.fullName(), 1, '', '', Enums.FolderFilter.Flagged));
		}
		else
		{
			return App.Routing.buildHashFromArray([Enums.Screens.Mailbox, this.fullName()]);
		}
	}, this);
	...
	this.usedAs = ko.computed(function () {
		switch (this.type())
		{
			case Enums.FolderTypes.Inbox:
				return Utils.i18n('SETTINGS/ACCOUNT_FOLDERS_USED_AS_INBOX');
			case Enums.FolderTypes.Sent:
				return Utils.i18n('SETTINGS/ACCOUNT_FOLDERS_USED_AS_SENT');
			case Enums.FolderTypes.Drafts:
				return Utils.i18n('SETTINGS/ACCOUNT_FOLDERS_USED_AS_DRAFTS');
			case Enums.FolderTypes.Trash:
				return Utils.i18n('SETTINGS/ACCOUNT_FOLDERS_USED_AS_TRASH');
			case Enums.FolderTypes.Spam:
				return Utils.i18n('SETTINGS/ACCOUNT_FOLDERS_USED_AS_SPAM');
		}
		return '';
	}, this);
	...
	this.displayName = ko.computed(function () {
		...
		{
			case Enums.FolderTypes.Inbox:
				return Utils.i18n('MAIN/FOLDER_INBOX');
			case Enums.FolderTypes.Sent:
				return Utils.i18n('MAIN/FOLDER_SENT');
			case Enums.FolderTypes.Drafts:
				return Utils.i18n('MAIN/FOLDER_DRAFTS');
			case Enums.FolderTypes.Trash:
				return Utils.i18n('MAIN/FOLDER_TRASH');
			case Enums.FolderTypes.Spam:
				return Utils.i18n('MAIN/FOLDER_SPAM');
		}
		return this.name();
	}, this);
...
CMessageModel.prototype.showInlinePictures = function (sAppPath)
{
	...
	Utils.Message.showInlinePictures(this.$text, aAttachments, this.foundCids(), sAppPath);
};
...
{
	Utils.Message.showExternalPictures(this.$text);
...
function CFetcherModel()
{
	...
	this.fullEmail = ko.computed(function () {
		return Utils.Address.getFullEmail(this.userName(), this.email());
	}, this);
}
...
CHtmlEditorViewModel.prototype.showLinkPopup = function ($link)
{
	...
	if (!App.browser.firefox && $composePopup.length === 1)
	{
		$(this.linkPopupDom()).css({
...
CHtmlEditorViewModel.prototype.insertLinkFromPopup = function (oCurrentViewModel, event)
{
	...
	{
		if (Utils.Address.isCorrectEmail(this.linkForInsert()))
		{
...
{
	var
		sViewLink = Utils.File.getViewLinkByHash(AppData.Accounts.currentId(), oAttachment.Hash),
		bResult = false
	;
