...
CSettingsViewModel.prototype.__name = 'CSettingsViewModel';
 ...
 * @param {Object} oRequest
 */
CSettingsViewModel.prototype.onResponseFolderRename = function (oInputFolder, oResponse, oRequest)
{
...
CSettingsViewModel.prototype.removeTab = function (sTabName)
{
	this.aTabs(
...
CSettingsViewModel.prototype.addTab = function (sTabName)
{
	this.aHiddenTabs(
