...
//	OpenPgpEncryptPopup = req-uire('modules/Mail/js/popups/OpenPgpEncryptPopup.js'),
	...
	CHtmlEditorViewModel = require('modules/Mail/js/views/CHtmlEditorViewModel.js'),
...
CComposeViewModel.prototype.onFileUploadSelect = function (sFileUid, oFileData)
{
	...
	if (Api.showErrorIfAttachmentSizeLimit(oFileData.FileName, Utils.pInt(oFileData.Size)))
    {
        return false;
    }
...
module.exports = CComposeViewModel;