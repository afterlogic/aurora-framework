 ...
 * @subpackage Storages
 */
class CApiContactsBaseDbStorage extends CApiContactsBaseStorage
{
	/**
	...
	/**
	 * @var CApiContactsBaseCommandCreator
	 */
	...
	public function __construct(AApiManager &$oManager)
	{
		...
		$this->oCommandCreator =& $oManager->GetCommandCreator(
			$this, array(
				EDbType::MySQL => 'CApiContactsBaseCommandCreatorMySQL',
				EDbType::PostgreSQL => 'CApiContactsBaseCommandCreatorPostgreSQL'
			)
		);
	}
