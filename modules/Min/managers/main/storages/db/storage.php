 ...
 * @subpackage Storages
 */
class CApiMinMainDbStorage extends CApiMinMainStorage
{
	/**
	...
	public function __construct(AApiManager &$oManager)
	{
		...
		$this->oCommandCreator =& $oManager->GetCommandCreator(
			$this, array(
				EDbType::MySQL => 'CApiMinMainCommandCreatorMySQL',
				EDbType::PostgreSQL => 'CApiMinMainCommandCreatorPostgreSQL'
			)
		);
	}
