...
//class CSimpleChatManager extends AApiManagerWithStorage
//{
//	/**
...
//	public function updateThread(CHelpdeskUser $oHelpdeskUser, CHelpdeskThread $oHelpdeskThread)
	 ...
	 * @return int
	 */
	public function getThreadsCount(\CUser $oUser, $sSearch = '')
	{
		$iResult = 0;
		try
