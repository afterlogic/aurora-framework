...
<tr>
	...
	<td align="left">
		<input class="wm_input <?php $this->Data->PrintInputValue('classTenantEmailInputHideClass') ?>" name="txtTenantInviteEmail" id="txtTenantInviteEmail" value="<?php $this->Data->PrintInputValue('txtTenantInviteEmailInput') ?>" />
		<b class="<?php $this->Data->PrintInputValue('classTenantEmailTextHideClass') ?>"><?php $this->Data->PrintEncodedHtmlValue('txtTenantInviteEmailText') ?></b>
